;; Base16 nsis (https://github.com/chriskempson/base16)
;; Scheme: Jan T. Sott

;;; base16-nsis-light-theme.el

;;; Code:

(deftheme base16-nsis-light)
...
(provide-theme 'base16-nsis-light)

;;; base16-nsis-light-theme.el ends here
